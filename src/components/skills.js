	...
	render() {
		return (
			<div className="wSkills">
				<AppBar title="Tech Skills" onClick={this.toggleCard}
				        style={MaterialUIStyles.appBar} titleStyle={MaterialUIStyles.appBar}
				        iconElementLeft={<IconBuild style={MaterialUIStyles.icon}/>}
				        iconElementRight={this.state.isHidden ?
					        <IconExpandMore onClick={this.toggleCard} style={MaterialUIStyles.icon}/> :
					        <IconExpandLess onClick={this.toggleCard} style={MaterialUIStyles.icon}/>}/>
